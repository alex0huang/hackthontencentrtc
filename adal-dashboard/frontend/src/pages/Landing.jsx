...
import { api, getToken, loginWithGitHub } from "../api.js";

const ONE_CLICK_INSTALL = `curl -fsSL https://raw.githubusercontent.com/alex0huang/hackthonadal/main/sec-reviewer/install.sh | bash`;
...
export default function Landing() {
  ...
  useEffect(() => {
    // If signed-in user lands on "/" without a hash, send them to the dashboard.
    // When they click "+ Install on repo" we get "/#install" — skip the redirect
    // and let the browser scroll to the section.
        ...
        {me ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="ml-2 px-4 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-semibold text-sm transition"
            >
              Back to Dashboard →
            </button>
          </div>
